      ...
      <main className="hidden lg:flex flex-1 overflow-hidden flex-row">
        ...
        <section className="w-1/2 bg-surface-container-lowest flex items-center justify-center p-20">
          <div className="w-full max-w-[440px] flex flex-col">
            ...
            <button type="button" className="flex items-center justify-center gap-3 w-full py-3.5 px-6 ghost-border rounded-md hover:bg-surface transition-colors duration-200 ambient-shadow">
      ...
      <main className="flex lg:hidden flex-col items-center">
        ...
        <section className="w-full max-w-md px-6 pb-20">
          <div className="bg-surface-container-lowest rounded-xl p-8 ambient-shadow ghost-border">
            {/* Social Login */}
            <button type="button" className="w-full flex items-center justify-center gap-3 py-4 rounded-md ghost-border hover:bg-surface-container-low transition-colors duration-200">
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"></path>
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"></path>
              ...
              <span className="font-body font-semibold text-on-surface">Continue with Google</span>
            </button>
